 ...
 */
export const DEFAULT_CHECKMARK_ICON = `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg>`;
...
export const SEGMENTED_BUTTON_ICONS = {
  ...
  CHECKMARK: DEFAULT_CHECKMARK_ICON,
} as const;
